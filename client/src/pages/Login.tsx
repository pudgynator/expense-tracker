        ...
        <div className="flex items-center justify-center bg-stone-100 px-4 min-h-screen ">
            <div className="flex flex-col min-w-sm py-8 px-4 items-center justify-center bg-white rounded-sm shadow-md">
                <div className="flex flex-col gap-2 items-center justify-center mb-10">
                    <LogIn className="h-6 w-6 text-lime-500" />
                ...
                <form className="flex flex-col gap-2 w-full px-4" onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center justify-between mb-6">
                        <label className="flex items-center leading-none gap-1.5  text-stone-400 text-sm">
                            <input type="checkbox" className="h-3.5 w-3.5 accent-lime-500" />
                                remember me?
                        </label>

                        <button type="button" className="text-sm leading-none text-lime-500 hover:underline">
                            Forgot password?
                        </button>
                    </div>
